...
class CityGraph:
    ...
    def load_data(self, dataset_name):
        ...
        self.cities = { city: Node(city, heur) for _, (city, heur) in enumerate(self.heuristic.items()) }
    ...
    def create_adj_list(self):
        ...
        for data in self.map:
            self.cities[data['city1']].child.append(ChildNode(self.cities[data['city2']], data["distance"]))
            self.cities[data['city2']].child.append(ChildNode(self.cities[data['city1']], data["distance"]))
